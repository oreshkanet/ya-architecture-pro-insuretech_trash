...
Для ограничения количества запросов со стороны партнёров необходимо внедрить Rate Limiting в сервисах интеграции. Это позволит контролировать SLA API и блокировать запросы клиентов в случае его наружения.
